...
if page == 'Homepage':
    ...
    st.markdown(
        f'<a href="data:file/pdf;base64,{base64_pdf}" download="{"Red and Gray Contemporary Editorial Landscape University Research Poster.pdf"}">Click here to download the poster</a>',
        unsafe_allow_html=True
    )
